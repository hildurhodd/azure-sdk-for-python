...
BP_LOCATION = 'southcentralus'
BP_RESOURCE_GROUP = 'bp_rg_python_sdk_test'

def create_backup_policy(client, backup_policy_name, rg=BP_RESOURCE_GROUP, account_name=TEST_ACC_1, location=BP_LOCATION, backup_policy_only=False):
...
def delete_backup_policy(client, backup_policy_name, rg=BP_RESOURCE_GROUP, account_name=TEST_ACC_1, live=False):
...
class NetAppAccountTestCase(AzureMgmtTestCase):
    ...
    def test_create_delete_backup_policy(self):
        ...
        backup_policies_list = self.client.BACKUP_POLICIES.list(BP_RESOURCE_GROUP, TEST_ACC_1)
        ...
        delete_account(self.client, BP_RESOURCE_GROUP, TEST_ACC_1, live=self.is_live)
    ...
    def test_list_backup_policies(self):
        ...
        delete_account(self.client, BP_RESOURCE_GROUP, TEST_ACC_1)

    def test_get_backup_policy_by_name(self):
        create_backup_policy(self.client, TEST_BACKUP_POLICY_1)

        backup_policy = self.client.BACKUP_POLICIES.get(BP_RESOURCE_GROUP, TEST_ACC_1, TEST_BACKUP_POLICY_1)
    ...
    def test_update_backup_policies(self):
        ...
        self.client.BACKUP_POLICIES.update(BP_RESOURCE_GROUP, TEST_ACC_1, TEST_BACKUP_POLICY_1, backup_policy_body)
